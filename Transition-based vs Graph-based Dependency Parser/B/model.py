...
class BISTParser(nn.Module):
    def __init__(self, w_emb_dim, pos_emb_dim, lstm_hid_dim, mlp_hid_dim, n_lstm_l,
                 ...
                 ex_w_vec=None, ext_emb_w2i=None, pretrained_word_vectors=None, activation_function="tanh"):
        ...
        if activation_function=="tanh":
            ...
            raise ValueError('Activation function must be one of {"tanh", "relu"}')
    ...
    def forward(self, sentence, pos_tags, gold_tree=None, word_dropout=False):
        ...
        # word dropout
        if word_dropout:
            unk_probs = torch.tensor([1 - (self.alpha / (self.w_i_counter.get(w_i.item(), 0) + self.alpha))
